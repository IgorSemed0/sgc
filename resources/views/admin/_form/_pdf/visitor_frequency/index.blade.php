...
@section('title', 'Filtros Relatório de Frequência de Visitantes')
@section('conteudo')
<form action="{{ route('pdf.visitor_frequency') }}" method="POST" class="mb-4">
    @csrf
    <h4>Filtros de Pesquisa - Frequência de Visitantes</h4>

    <div class="mb-3">
        <label>BI do Visitante:</label>
        <input type="text" name="bi" placeholder="Ex: 123456789LA012" class="form-control">
    </div>
